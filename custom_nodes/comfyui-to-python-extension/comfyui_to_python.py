...
class ComfyUItoPython:
    ...
    def execute(self):
        ...
        if self.input_file:
            # If the input file is a relative path, make it absolute from the original directory
            if not os.path.isabs(self.input_file):
                original_dir = os.getcwd()
                # Find the ComfyUI directory to get back to the original location
                comfyui_path = find_path("ComfyUI")
                if comfyui_path:
                    # Go back to the custom_nodes/comfyui-to-python-extension directory
                    original_dir = os.path.join(comfyui_path, "custom_nodes", "comfyui-to-python-extension")
                self.input_file = os.path.join(original_dir, self.input_file)
        ...
        # If the output file is a relative path, make it absolute from the original directory
        if not os.path.isabs(self.output_file):
            ...
            if comfyui_path:
                # Go back to the custom_nodes/comfyui-to-python-extension directory
                original_dir = os.path.join(comfyui_path, "custom_nodes", "comfyui-to-python-extension")
            self.output_file = os.path.join(original_dir, self.output_file)
